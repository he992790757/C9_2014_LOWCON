...
//					System.Sys.Data.info.SoftwareVer[2] =	((uint32_t)u32Cmd[13] <<24) + ((uint32_t)u32Cmd[14] <<16)+( (uint32_t)u32Cmd[15] <<8)+(uint32_t)u32Cmd[16];
				...
				{   
					...
					GR_DBG_PRINTF("\n\nScene is %x %x %x %x %x %x %x %x %x %x %x\n\n ",
									u32Cmd[5],
									System.Dsp.photo.Scene[u32Cmd[5]].FB1,
									System.Dsp.photo.Scene[u32Cmd[5]].FB2,
									System.Dsp.photo.Scene[u32Cmd[5]].FC1,
									System.Dsp.photo.Scene[u32Cmd[5]].FC2,
									System.Dsp.photo.Scene[u32Cmd[5]].Sharpness,
									System.Dsp.photo.Scene[u32Cmd[5]].Contrast,
									System.Dsp.photo.Scene[u32Cmd[5]].Brightness,
									System.Dsp.photo.Scene[u32Cmd[5]].Saturation,
									System.Dsp.photo.Scene[u32Cmd[5]].WB1,
									System.Dsp.photo.Scene[u32Cmd[5]].WB2
									);
...
//		case V6M_CMD_FZ:{ptr = }break;					//52:									 //照片分组  
//		{
////			USB_DATA.USB_COMM=0x04;
////			USB_DATA.LED_CLASS=V6M_CMD_FZ;
//			break;
//		}
